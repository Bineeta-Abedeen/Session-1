...
# Accessing elements
print("Element at (3, 2):", matrix_2d[2][1])  # Access element at third row, second column

# Modifying an element
matrix_2d[1][2] = 10  # Changing the first element of the third row to 10
...
mixed_data_tuple = ("Mahi", 25, 3.9, True)

# Using tuple as a dictionary key
student_dict = {
    mixed_data_tuple: "Student Data"
}

# Accessing the dictionary
print("Dictionary with tuple as key:")
print(student_dict)
...
# Write your code below:
# List of tuples with students and grades
students_grades = [
    ("Araf", 85),
    ("Arat", 92),
    ("Nazifa", 78),
...
# Sorting by grades
sorted_students = sorted(students_grades, key=lambda x: x[1])
